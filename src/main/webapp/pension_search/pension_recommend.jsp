...
<link rel="stylesheet" href="../css/pension_search.css" />
...
<%
	...
	//시티 값과자식 값 지정.
	String cityName = pension_category.cityname(intCity);
	String cityChildName = pension_category.cityChildname(intCity,intCityChild);
	%>
...
<%@ include file="/pension_search/pension_filter.jsp" %>
<%@ include file="/pension_search/pension_list.jsp"%>
